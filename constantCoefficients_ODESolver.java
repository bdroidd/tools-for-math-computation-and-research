...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        // instantiates a differential equation with arbitrary constant 
        //  coefficeints & initial values (that will later be determined by the user)
        ...
        {
        // edit: find unicode symbols for superscript (of in-line equations)

            double C1, C2, r;

            // translate from Latex to Java 
            if ((r1 != r2) && ((r1 && r2) \in \R)
            {
            ...
            {
                \\ translate from Latex to unicode
